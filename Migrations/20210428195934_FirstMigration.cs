        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorOwner = table.Column<string>(nullable: false),
                    VendorEmail = table.Column<string>(nullable: false),
                    VendorSite = table.Column<string>(nullable: false),
                    VendorPhone = table.Column<string>(nullable: false),
                    VendorLocation = table.Column<string>(nullable: false),
                    VendorDescription = table.Column<string>(nullable: false),
                    VendorJoinDate = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReviewId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ReviewMessage = table.Column<string>(nullable: false),
                    ReviewImage = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorReviews_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorReviews_ReviewId",
                table: "VendorReviews",
                column: "ReviewId");
